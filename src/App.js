...
import Shaum from './images/shaum.jpg';
    ...
    <div className="flex min-h-screen flex-col items-center justify-center relative bg-primary pb-20">
      <nav className="w-full px-6 z-50 fixed inset-x-0 top-2 flex justify-center items-center">
        <div className="w-full md:w-880 bg-navBar p-4 rounded-2xl flex items-center">
          <p className="text-lg text-slate-200 font-medium">shaum.dev</p>
      ...
      <div className="relative" id="home">
        ...
        <div className="absolute bottom-20 w-full flex justify-center items-center">
            <div className="shadow-md p-4 flex items-center justify-center bg-zinc-900 rounded-3xl">
              <a href="#about hover:text-slate-100 cursor-pointer duration-100 ease-in-out" className="text-white">Click to Continue</a>
            </div>
          </div>
      </div>
      ...
      <main className="w-[80%] mt-20">
            <section className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 my-24" id="about">
              ...
              <div className="w-full h-420 flex items-center justify-center">
                <div className="w-275 h-340 relative bg-purple-300 rounded-md">
                  <img src={Shaum}
                    alt="Shaum"
              ...
              <div className="w-full h-420   flex flex-col items-center justify-center">
                  <p className="text-lg text-textBase text-center">Hi, I’m Shaumprovo Debnath. I like a lot of things, including the sciences, mathematics, and art. In particular, I’m fascinated by computer science, but my real passion is astrophysics, which I hope to study someday to unlock the secrets of the universe.
                  </p>

                  <motion.button whileTap={{scale : 0.8}} class="w-full md:w-auto relative mt-6 inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-400 to-purple-600 group-hover:from-purple-400 group-hover:to-purple-600 hover:text-white dark:text-white focus:ring-4 focus:ring-purple-200 dark:focus:ring-purple-800 hover:shadow-lg hover:shadow-teal-500/50 hover:dark:shadow-lg hover:dark:shadow-purple-800/80">
            ...
            <section className="flex flex-wrap items-center justify-evenly my-24 gap-4" id="Projects">
              ...
              <div key={n.id} className="border border-zinc-800 rounded-md p-2 min-w-[275px] md:max-w-[275px] hover:border-zinc-600 duration-100">
